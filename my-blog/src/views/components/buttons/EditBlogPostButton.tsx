    ...
    return (
        <div>
            <Link
                ...
                to={editUrl}
                className="inline-block font-nunito p-2 pr-6 pl-6 rounded-md focus:outline-none bg-gradient-to-r from-info-start to-info-end text-white hover:animate-light-up "
            >
                Edit
            </Link>
        </div>
